...
<head>
    ...
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $emailquery = "select * from res where email = '$email'";
            ...
            if($emailcount>0){
                ...
                if($password === $cpassword){
                    $insertquery = "insert into res( username, email, phone, password, cpassword) values( '$username', '$email', '$phone', '$pass', '$cpass')";
